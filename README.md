...
```javascript
abs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-special-abs@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-special-abs@v0.3.1-umd/browser.js"></script>
```
